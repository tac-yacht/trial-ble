...
static mp_obj_t begin(size_t n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
	static const mp_arg_t allowed_args[] = {
		...
		{MP_QSTR_subnet, MP_ARG_OBJ, {.u_obj = MP_OBJ_FROM_PTR(mp_obj_new_str("255.255.255.255",15))}},
		{MP_QSTR_gateway, MP_ARG_OBJ, {.u_obj = MP_OBJ_FROM_PTR(mp_obj_new_str("0.0.0.0",7))}},
